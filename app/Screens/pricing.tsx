...
const PackageCard: React.FC<PackageCardProps> = ({ title, price, duration, percentage }) => (
  <LinearGradient
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.disclaimer}>
            * Please note that the treatment durations mentioned are typical timelines and individual cases may vary.
          </Text>

          <Text style={styles.footerText}>
            Take your first step towards your radiant smile today and submit your smile assessment. Our experienced team are here to make your dream smile a reality.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
